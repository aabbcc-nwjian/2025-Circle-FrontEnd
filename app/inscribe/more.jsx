   ...
   return (
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          setSelectedOptions(prevOptions => {
            if (prevOptions.includes('A')) {
              return prevOptions.filter(item => item !== 'A');
            } else {
              return [...prevOptions, 'A'];
            }
          });
        }}
      >
        {selectedOptions.includes('A') && <View style={style.circle2}></View>}
      </TouchableOpacity>
    </View>
    <View style={[style.choose, {marginTop:25}]}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          setSelectedOptions(prevOptions => {
            if (prevOptions.includes('B')) {
              return prevOptions.filter(item => item !== 'B');
            } else {
              return [...prevOptions, 'B'];
            }
          });
        }}
      >
        {selectedOptions.includes('B') && <View style={style.circle2}></View>}
      </TouchableOpacity>
    </View>
    <View style={[style.choose, {marginTop:25}]}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          setSelectedOptions(prevOptions => {
            if (prevOptions.includes('C')) {
              return prevOptions.filter(item => item !== 'C');
            } else {
              return [...prevOptions, 'C'];
            }
          });
        }}
      >
        {selectedOptions.includes('C') && <View style={style.circle2}></View>}
      </TouchableOpacity>
    </View>
    <View style={[style.choose, {marginTop:25},{marginBottom:15}]}>
      ...
      <TouchableOpacity 
        ...
        onPress={() => {
          setSelectedOptions(prevOptions => {
            if (prevOptions.includes('D')) {
              return prevOptions.filter(item => item !== 'D');
            } else {
              return [...prevOptions, 'D'];
            }
          });
        }}
      >
        {selectedOptions.includes('D') && <View style={style.circle2}></View>}
      </TouchableOpacity>
    </View>
</View>
